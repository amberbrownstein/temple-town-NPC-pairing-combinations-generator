I developed this algorithm to help me come up with combinations of different pairings for a farming simulator I am creating.

Like many farming games, this one will allow the player to date and marry certain townsfolk. However, each romanceable character (aside from ones who are secretly romanceable) will have 2 different romantic rivals in the initial release of the game. While romantic rivals will not prevent a player from being able to date or marry their character of choice, they can add difficulty if said NPC develops a closer relationship with a rival than the one that they have with the player.
